        ...
        <section className="py-8 bg-white overflow-hidden pb-16">
            <div className="max-w-[1400px] mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                >
                    ...
                    <ImageWithFallback
                        src="https://images.unsplash.com/photo-1621996346565-e3dbc646d9a9?auto=format&fit=crop&q=80&w=1000" // Pasta/Spaghetti
                        alt="Pasta Background"
                        className="relative md:absolute md:right-[-20px] md:top-10 h-[250px] md:h-[90%] w-full md:w-2/3 object-contain object-center md:object-right rotate-0 group-hover:scale-105 transition-transform duration-700 order-2 md:order-none"
                    />
                    ...
                    <div className="relative z-20 h-auto md:h-full flex flex-col justify-center items-start p-8 md:pl-12 w-full md:max-w-[50%] order-1 md:order-none">
                        <p className="text-[#1c1c1c] font-medium text-lg mb-1 font-['Outfit']">Taste of Italy</p>
                        <div className="mb-6">
                            <h2 className="text-4xl md:text-5xl font-bold text-[#1c1c1c] leading-[1.1] mb-2 font-['Outfit']">
                                Great Deals on Your
                            </h2>
                            <h2 className="text-4xl md:text-6xl font-extrabold text-[#1c1c1c] leading-[1.1] font-['Outfit']">
                                Favorite Pastas
                            </h2>
                        </div>

                        <Button
                            onClick={() => setCurrentPage("search", { category: "Food" })}
                ...
                >
                    ...
                    <div className="relative z-20 h-auto md:h-full flex flex-col justify-center items-start p-8 md:pl-12 w-full md:max-w-[50%] order-1 md:order-none">
                        ...
                        <Button
                            onClick={() => setCurrentPage("search", { category: "Breakfast" })}
                            className="bg-[#ED1C24] hover:bg-red-700 text-white px-8 py-3 rounded-full font-bold text-sm uppercase tracking-wide shadow-sm font-['Outfit']"
                        >
                            Shop Now
                        </Button>
